...
func handleHTTPServer(ctx context.Context, u *url.URL, sSAServerEndpoints *ssaserver.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	// responses.
	var (
		sSAServerServer *ssaserversvr.Server
	)
	{
	...
	for _, m := range sSAServerServer.Mounts {
